...
function createGUI (withStats) {
  GUIcontrols = new function() {
    ...
    //this.mensaje = function () {
      setMessage ("Esto es un mensaje de prueba");
      //applicationMode = TheScene.ADDING_BOXES;
   // };
    this.fixedPosition = function(){
      setMessage ("Posición reiniciada");
      this.rotation = 6;
      this.distance = 10;
      this.height = 10;
    }
  ...
  var axisLights = gui.addFolder ('Axis and Lights');
    ...
    axisLights.add(GUIcontrols, 'extraLight').name('Extra light on/off :')
  ...
  var craneControls = gui.addFolder ('Crane Controls');
    ...
    var fixedPosition = craneControls.add(GUIcontrols, 'fixedPosition').name (': Fix position :');
